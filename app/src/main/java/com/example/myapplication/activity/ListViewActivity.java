...
import com.example.myapplication.bean.NodeData;
import com.example.myapplication.treelist.Node;
import com.example.myapplication.treelist.OnTreeNodeCheckedChangeListener;
...
public class ListViewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new ListViewAdapter(mListView, this, dataList,
                0, R.drawable.ic_launcher_background, R.drawable.ic_launcher_background);
